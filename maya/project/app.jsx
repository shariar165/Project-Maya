  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative' }}>
        <Tara size={260} mood={s.mood} halo/>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Screen state={state} setState={setState} openScreen={openScreen} tweak={t} setTweak={setTweak}/>
      </div>

      {!isVoice && !isSubPage && <BottomNav screen={screen} setScreen={setScreen}/>}

      {showIntro && !showSplash && <Onboarding onDone={() => setShowIntro(false)} state={state} setState={setState}/>}
